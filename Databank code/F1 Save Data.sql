...
----------------------------------------------------------------------
-- Inserting Data into F1 Databank
----------------------------------------------------------------------
USE Formula1;
GO

--- just if needed to delete a table
---delete from Driver
---delete from Team
---delete from DriverInTeam
---delete from FirstPlace
---delete from SecondPlace
---delete from ThirdPlace
---delete from Race
...
INSERT INTO Race (RaceName, RaceDate, RaceLocation, Country, CircuitName, CircuitLengthKM, NumberOfLaps, RaceDistanceKM, LapRecord, NumberOfCorners, YearOf1GP, fk_Result1ID, fk_Result2ID, fk_Result3ID)
VALUES
...
('Formula 1 Gulf Air Bahrain Grand Prix 2023', '2023-03-05', 'Sakhir', 'BHR', 'Bahrain International Circuit', 5.412, 57, 308.238, '1:31.447', 15, 2004,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 1),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 1),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 1)),
('Formula 1 STC Saudi Arabian Grand Prix 2023', '2023-03-19', 'Jeddah', 'SAU', 'Jeddah Corniche Circuit', 6.174, 50, 308.45, '1:30.734', 27, 2021,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 2),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 2),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 2)),
('Formula 1 Rolex Austrlian Grand Prix 2023', '2023-04-02', 'Melbourne', 'AUS', 'Albert Park Circuit', 5.278, 58, 306.124, '1:20.235', 14, 1996,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 3),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 3),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 3)),
('Formula 1 Azerbaijan Grand Prix 2023', '2023-04-30', 'Baku', 'AZE', 'Baku City Circuit', 6.003, 51, 306.049, '1:43.009', 20, 2016,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 4),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 4),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 4)),
('Formula 1 Crypto.com Miami Grand Prix 2023', '2023-05-07', 'Miami', 'USA', 'Miami International Circuit', 5.412, 57, 308.326, '1:29.708', 19, 2022,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 5),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 5),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 5)),
('Formula 1 Grand Premio E Del Emila-Romagna 2023', '2023-05-21', 'Imola', 'ITA', 'Autodromo Enzo e Dino Ferrari', 4.909, 63, 309.049, '1:15.484', 19, 1980,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 6),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 6),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 6)),
('Formula 1 Grand Prix de Monaco 2023', '2023-05-28', 'Monaco', 'MCO', 'Circuit de Monaco', 3.337, 78, 260.286, '1:12.909', 19, 1950,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 7),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 7),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 7)),
('Formula 1 AWS Grand Premio de España 2023', '2023-06-04', 'Barcelona', 'ESP', 'Circuit de Barcelona-Catalunya', 4.657, 66, 307.236, '1:16.330', 14, 1991,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 8),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 8),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 8)),
('Formula 1 Pirelli Grand Prix du Canada 2023', '2023-06-18', 'Montreal', 'CAN', 'Circuit Gilles-Villeneuve', 4.361, 70, 305.27, '1:13.078', 14, 1978,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 9),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 9),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 9)),
('Formula 1 Rolex Grosser Preis von Österreich 2023', '2023-07-02', 'Spielberg', 'AUT', 'Red Bull Ring', 4.318, 71, 306.452, '1:05.619', 10, 1970,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 10),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 10),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 10)),
('Formula 1 Aramco British Gran Prix 2023', '2023-07-09', 'Silverstone', 'GBR', 'Silverstone Circuit', 5.891, 52, 306.198, '1:27.097', 18, 1950,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 11),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 11),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 11)),
('Formula 1 Quater Airways Hungarian Grand Prix 2023', '2023-07-23', 'Mogyorod', 'HUN', 'Hungaroring', 4.381, 70, 306.63, '1:16.627', 14, 1989,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 12),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 12),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 12)),
('Formula 1 MSC Cruises Belgian Grand Prix 2023', '2023-07-30', 'Stavelot', 'BEL', 'Circuit de Spa-Francorchamps', 7.004, 44, 308.052, '1:46.286', 19, 1950,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 13),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 13),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 13)),
('Formula 1 Heineken Dutch Grand Prix 2023', '2023-08-27', 'Zandvoort', 'NED', 'Circuit Zandvoort', 4.259, 72, 306.587, '1:11.097', 14, 1952,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 14),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 14),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 14)),
('Formula 1 Pirelli Gran Premio D Italia 2023', '2023-09-03', 'Monza', 'ITA', 'Autodromo Nazionale Monza', 5.793, 53, 306.72, '1:21.046', 11, 1950,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 15),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 15),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 15)),
('Formula 1 Singapore Airlines Singapore Grand Prix 2023', '2023-09-17', 'Marina Bay', 'SGP', 'Marina Bay Street Circuit', 4.94, 62, 306.143, '1:35.867', 19, 2008,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 16),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 16),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 16)),
('Formula 1 Lenovo Japanese Grand Prix 2023', '2023-09-24', 'Suzuka', 'JPN', 'Suzuka International Racing Course', 5.807, 53, 307.471, '1:30.983', 18, 1987,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 17),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 17),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 17)),
('Formula 1 Quater Airways Quatar Grand Prix 2023', '2023-10-08', 'Lusail', 'QAT', 'Lusail International Circuit', 5.419, 57, 308.611, '1:24.319', 16, 2021,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 18),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 18),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 18)),
('Formula 1 Lenovo United States Grand Prix 2023', '2023-10-22', 'Austin', 'USA', 'Circuit of the Americas', 5.513, 56, 308.405, '1:36.169', 56, 2012,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 19),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 19),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 19)),
('Formula 1 Gran Premio de la Ciudad de Mexico 2023', '2023-10-29', 'Mexico', 'MEX', 'Autodromo Hermanos Rodriguez', 4.304, 71, 305.354, '1:17.774', 17, 1963,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 20),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 20),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 20)),
('Formula 1 Rolex Grande Premio de São Paulo 2023', '2023-11-05', 'São Paulo', 'BRA', 'Autodromo Jose Carlos Pace', 4.309, 71, 305.879, '1:10.540', 15, 1973,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 21),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 21),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 21)),
('Formula 1 Heineken Silver Las Vegas Grand Prix 2023', '2023-11-19', 'Las Vegas', 'USA', 'Las Vegas Strip Circuit', 6.201, 50, 310.05, '1:35.490', 17, 2023, 
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 22),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 22),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 22)),
('Formula 1 Etihad Airways Abu Dhabi Grand Prix 2023', '2023-11-26', 'Yas Marina', 'AUH', 'Yas Marina Circuit', 5.281, 58, 306.183, '1:26.103', 16, 2009,
    (SELECT Result1ID FROM FirstPlace WHERE Result1ID = 23),
    (SELECT Result2ID FROM SecondPlace WHERE Result2ID = 23),
    (SELECT Result3ID FROM ThirdPlace WHERE Result3ID = 23));
...
--- Test to see if all the data in the tables are correct
select * from Driver;
select * from Team; 
select * from DriverInTeam;
select * from FirstPlace;
select * from SecondPlace;
select * from ThirdPlace;
select * from Race;



--- Test if DriverInTeam works correctly
select Team.TeamName, Driver.FirstName, Driver.LastName from DriverInTeam 
join Team on TeamID = fk_TeamID
join Driver on DriverID = fk_DriverID
where fk_TeamID = 14
